      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              '<div class="btn-group">' +
              '<a href="javascript:void(0)" data-toggle="modal" data-target="#modals-slide-in" class="dropdown-item" onclick="___getEditableRecords('+full['id']+');">' + feather.icons['archive'].toSvg({ class: 'font-small-4 mr-50' }) + 'Edit</a>' +
