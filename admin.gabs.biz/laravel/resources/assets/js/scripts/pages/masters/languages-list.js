      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            // Creates full output for row
            var $row_output =
              '<div class="d-flex justify-content-left align-items-center">' + '<div class="d-flex flex-column">' + '<span class="font-weight-bold">' + $caption + '</span>' + '</div>' + '</div>';
            return $row_output;
          }
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            // Creates full output for row
            var $row_output =
              '<div class="d-flex justify-content-left align-items-center">' + '<div class="d-flex flex-column">' + '<span class="font-weight-bold">' + $alias + '</span>' + '</div>' + '</div>';
            return $row_output;
          }
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $checked = '';
            if(full['for_web'] == 'Yes')  $checked = ' checked="checked" disabled="disabled"';
            var $row_output = '<div class="form-group"><div class="custom-control custom-control-success custom-checkbox">' + 
              '<input class="custom-control-input" style="opacity:1 !important;" type="checkbox" onclick="___updateForWebStatus('+full['id']+');" value="'+full['id']+'" id="checkbox_forweb' + full['id'] +'" '+$checked+'/>'+
              '</div></div>';
              return $row_output;
          }
        },
