...
class SubCategory extends Model
{
    ...
    protected $fillable = ['name','title_languages','display', 'parent_id', 'main_category'];
  ...
  //each category might have multiple children
    ...
    public function scopeMainCategory($query, $main_category){
        return $query->where('main_category',$main_category);
    }
