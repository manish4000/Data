...
class TypeController extends Controller
{
    ...
    public function __construct(UrlGenerator $url) {
        ...
        ####    DATATABLE HEADER COLUMNS COLLECTION START FROM HERE ####
        $this->dataListCols[0]['caption']   = '';
        $this->dataListCols[0]['class']     = '';

        $this->dataListCols[1]['caption']   = $this->moduleName;
        $this->dataListCols[1]['class']     = '';

        $this->dataListCols[2]['caption']   = 'Parent';
        $this->dataListCols[2]['class']     = '';

        $this->dataListCols[3]['caption']   = 'Display';
        $this->dataListCols[3]['class']     = '';

        $this->dataListCols[4]['caption']   = 'Action';
        $this->dataListCols[4]['class']     = 'text-center w-25';
        ####    DATATABLE HEADER COLUMNS COLLECTION END HERE ####
    }


    public function indexDataTable()
    {
        $__data = Type::where('display', 'Yes')->where('parent_id', 0)->orWhere('parent_id', null)->get();
        ...
        return view($this->basePath.'commonlist', ['pageConfigs' => $pageConfigs, '__parentData'=>$__data, 'breadcrumbs' => $this->breadcrumbs]);
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('content.admin.masters.vechiles.types.list', ['pageConfigs' => $pageConfigs, '__parentData'=>$__data, 'breadcrumbs' => $this->breadcrumbs, 'data'=>$data]);
    }
