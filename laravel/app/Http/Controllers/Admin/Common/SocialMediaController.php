...
class SocialMediaController extends Controller
{
    ...
    {    
        ...
        return view('content.admin.masters.common.social_media.list', ['pageConfigs' => $pageConfigs, 'breadcrumbs' => $breadcrumbs, 'data'=>$data,'perPage' => $perPage]);
    }
    ...
    public function add() {
        ...
        return view('content.admin.masters.common.social_media.create-form',['menuUrl' =>$this->menuUrl,'breadcrumbs' =>$breadcrumbs]);
    }
    ...
    {   
        ...
        return view('content.admin.masters.common.social_media.create-form',['data' => $data,'breadcrumbs' =>$breadcrumbs ,'activeSiteLanguages' => $activeSiteLanguages ,'menuUrl' =>$this->menuUrl]);
