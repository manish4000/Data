...
trait HasDashPermissionsTrait {
  ...
  //   }
    ...
    public function roles() {
      ...
      return $this->belongsToMany(CompanyRole::class,'user_roles');
    ...
    protected function getAllPermissions(array $permissions) {
      ...
      return CompanyMenuGroupMenu::whereIn('permission_slug',$permissions)->get();
