      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            // Creates full output for row
            var $row_output =
              '<div class="d-flex justify-content-left align-items-center">' + '<div class="d-flex flex-column">' + '<span class="font-weight-bold">' + $symbol + '</span>' + '</div>' + '</div>';
            return $row_output;
          }
        },
        {
          ...
          responsivePriority: 4,
          render: function (data, type, full, meta) {
            var $special_price_difference = full['special_price_difference'];
            if($special_price_difference==null) $special_price_difference = '';
            // Creates full output for row
            var $row_output =
              '<div class="d-flex justify-content-left align-items-center">' + '<div class="d-flex flex-column">' + '<span class="font-weight-bold">' + $special_price_difference + '</span>' + '</div>' + '</div>';
            return $row_output;
          }
        },
        {
