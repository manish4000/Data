             ...
             <div class="card card-primary">
                  <div class="card-header">
                     ...
                     <hr class="m-0 p-0">
                       <div class="card-body">
                          <div class="row">
                              <div class="col-md-6">Accept payments via</div>
                               <div class="col-md-6">                                
                                   <div class="row">
                                     <div class="col-md-4"><x-dash.form.label for="" value="{{__('webCaption.proforma_no.title')}}" class="" tooltip="{{__('webCaption.proforma_no.caption')}}" /></div>
                                      ...
                                      <div class="col-md-5 pl-0">
                                          <div class="form-group">
                                              <x-dash.form.inputs.text for="proforma_id"  tooltip="{{__('webCaption.proforma_id.caption')}}"   class="form-control" name="vehicle_title"  placeholder="{{__('webCaption.proforma_id.title')}}" value="{{old('vehicle_title', isset($data->title)?$data->vehicle_title:'' )}}"  required="" />
                                               @if ($errors->has('title'))
                                       ...
                                       <div class="col-md-3 pl-0">
                                            <div class="form-group mb-0">
                                                <x-dash.form.inputs.date  for="purchase_date"  maxlength="255" tooltip="{{__('webCaption.purchase_date.caption')}}" name="purchase_date"  placeholder="{{__('webCaption.purchase_date.title')}}" value="{{old('purchase_date', isset($data->purchase_date)?$data->purchase_date:'' )}}"  required="" />
                                            </div>
                                       </div>
                 ...
                 <div class="card card-primary">
                      <div class="card-header">
                        ...
                        <hr class="m-0 p-0">
                          <div class="card-body">
                              <div class="row">
                                  <div class="col-md-12">Accept payments via</div>
