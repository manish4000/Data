...
@if (isset($data->id) && !empty($data->id))
    @section('title', __('webCaption.client.title') . ' ' . __('webCaption.edit.title'))
@else
    @section('title', __('webCaption.client.title') . ' ' . __('webCaption.add.title'))
@endif
@section('content')
    <div>
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="row">
                                ...
                                <div class="col-md-9 col-8 pl-0">
                                    <div class="form-group">
                                        <x-dash.form.inputs.text id="" label="{{ __('webCaption.name.title') }}"
                                            ...
                                            placeholder="{{ __('webCaption.name.title') }}"
                                            value="{{ old('name', isset($data->id) ? $data->name : '') }}"
                                            required="required" />
                                        @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                @if (isset($data->id))
                                    <x-dash.form.inputs.text for="customer_uid"
                                        ...
                                        label="{{ __('webCaption.customer_uid.title') }}" class="form-control"
                                        name="customer_uid" placeholder="{{ __('webCaption.customer_uid.title') }}"
                                        value="{{ old('customer_uid', isset($data->customer_uid) ? $data->customer_uid : '') }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-dash.form.inputs.email id="" for="email_1"
                                    tooltip="{{ __('webCaption.email_1.caption') }}"
                                    label="{{ __('webCaption.email_1.title') }}" maxlength="50" class="form-control"
                                    name="email_1" placeholder="{{ __('webCaption.email_1.title') }}"
                                    value="{{ old('email_1', isset($data->id) ? $data->email_1 : '') }}"
                                    required="required" />
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-dash.form.inputs.email id="" for="email_2"
                                    tooltip="{{ __('webCaption.email_2.caption') }}"
                                    label="{{ __('webCaption.email_2.title') }}" maxlength="50" class="form-control"
                                    name="email_2" placeholder="{{ __('webCaption.email_2.title') }}"
                                    value="{{ old('email_2', isset($data->id) ? $data->email_2 : '') }}"
                                    required="" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-3 col-5">
                                    @php
                                        $mobile = isset($data->mobile_1) && !empty($data->mobile_1) ? explode('_', $data->mobile_1) : null;
                                    ...
                                    <div class="form-group">
                                        <x-dash.form.inputs.select tooltip="{{ __('webCaption.country_code.caption') }}"
                                            ...
                                            for="country_code_1" name="country_code_1" required="" :optionData="$country_code"
                                ...
                                <div class="col-md-5 col-7 pr-md-0 pl-0">
                                    <div class="form-group">
                                        <x-dash.form.inputs.number for="mobile_1" maxlength="15"
                                ...
                                <div class="col-md-4">
                                    ...
                                    @endif
                                    <div class="form-group">
                                        @include('components.dash.form.inputs.messenger_common', [
                                            'id' => 'messenger_1',
                                            'name' => 'messenger_1',
                                            'editSelected' => $edit_messenger,
                                        ])
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-3 col-5">
                                    @php
                                        $mobile = isset($data->mobile_2) && !empty($data->mobile_2) ? explode('_', $data->mobile_2) : null;
                                    ...
                                    <div class="form-group">
                                        <x-dash.form.inputs.select tooltip="{{ __('webCaption.country_code.caption') }}"
                                            label="{{ __('webCaption.country_code.title') }}" id=""
                                            for="country_code_2" name="country_code_2" required="" :optionData="$country_code"
                                            editSelected="{{ isset($country_code_2) && $country_code_2 != null ? $country_code_2 : '' }}" />
                                    </div>
                                </div>
                                <div class="col-md-5 col-7 pr-md-0 pl-0">
                                    <div class="form-group">
                                        <x-dash.form.inputs.number for="mobile_2" maxlength="15"
                        ...
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                <x-dash.form.label for="" value="{{ __('webCaption.dealer_type.title') }}"
                                    class="" tooltip="{{ __('webCaption.dealer_type.caption') }}"
                                    required="" />
                                <div>
                                    <div class="form-check-inline">
                                        <x-dash.form.inputs.radio for="dealer"
                                            tooltip="{{ __('webCaption.dealer.caption') }}" class="border border-danger"
                                            name="dealer_type" label="{{ __('webCaption.dealer.title') }}"
                                            value="Dealer"
                                        ...
                                        <x-dash.form.inputs.radio for="individual_buyer" class="border border-danger"
                                            ...
                                            label="{{ __('webCaption.individual_buyer.title') }}" value="Buyer"
                                            required=""
                        ...
                        <div class="col-md-2 col-6">
                            <div class="form-group">
                                <x-dash.form.label for="" value="{{ __('webCaption.member_login.title') }}"
                                    class="" tooltip="{{ __('webCaption.member_login.caption') }}"
                                    required="" />
                                <div>
                                    <div class="form-check-inline">
                                        <x-dash.form.inputs.radio for="yes"
                                            tooltip="{{ __('webCaption.yes.caption') }}" class="border border-danger"
                                            name="member_login" label="{{ __('webCaption.yes.title') }}" value="Yes"
                                        ...
                                        <x-dash.form.inputs.radio for="no" class="border border-danger"
                                            name="member_login" tooltip="{{ __('webCaption.no.caption') }}"
                        ...
                        <div class="col-md-2 col-6">
                            <div class="form-group">
                                <x-dash.form.label for="" value="{{ __('webCaption.broker.title') }}"
                                    class="" tooltip="{{ __('webCaption.broker.caption') }}" required="" />
                                <div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <x-dash.form.inputs.textarea id="" for="address"
                                    ...
                                    value="{{ old('address', isset($data->id) ? $data->address : '') }}"
                                    required="" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-2 col-6">
                            <div class="form-group">
                                <x-dash.form.inputs.text id="" for="zip_code"
                                    ...
                                    value="{{ old('zip_code', isset($data->id) ? $data->zip_code : '') }}"
                                    required="" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h4 class="card-title">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-layers font-medium-3 mr-1">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-dash.form.inputs.select label="{{ __('webCaption.religion.title') }}"
                                    ...
                                    placeholder="{{ __('locale.religion.caption') }}" :optionData="$religion"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <x-dash.form.inputs.select label="{{ __('webCaption.nationality.title') }}"
                                    tooltip="{{ __('webCaption.nationality.caption') }}" for="nationality"
                                    name="nationality" placeholder="{{ __('locale.nationality.caption') }}"
                                    :optionData="$country"
                        ...
                        <div class="col-md-2 col-6">
                            <div class="form-group">
                                <x-dash.form.inputs.date for="birth_date"
                                    tooltip="{{ __('webCaption.birth_date.caption') }}"
                                    label="{{ __('webCaption.birth_date.title') }}" class="form-control"
                                    name="birth_date" placeholder="{{ __('webCaption.birth_date.title') }}"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <x-dash.form.inputs.date for="next_follow_up_date"
                                    ...
                                    placeholder="{{ __('webCaption.next_follow_up_date.title') }}"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <x-dash.form.inputs.textarea id="" for="admin_memo"
                                    ...
                                    label="{{ __('webCaption.admin_memo.title') }}" maxlength="250"
                                    class="form-control" name="admin_memo"
                                    placeholder="{{ __('webCaption.admin_memo.title') }}"
                                    value="{{ old('admin_memo', isset($data->id) ? $data->admin_memo : '') }}"
                                    required="" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-2 col-5">
                            <div class="form-group">
                                <x-dash.form.inputs.select label="{{ __('webCaption.currency.title') }}"
                                    ...
                                    placeholder="{{ __('locale.currency.caption') }}" :optionData="$currency"
                        ...
                        <div class="col-md-4 col-7">
                            ...
                            <div class="form-group">
                                <x-dash.form.inputs.number id="" for="opening_balance"
                                    ...
                                    label="{{ __('webCaption.opening_balance.title') }}" class="form-control"
                                    name="opening_balance" placeholder="{{ __('webCaption.opening_balance.title') }}"
                                    maxlength="20"
                                    value="{{ old('opening_balance', isset($data->opening_balance) ? $opening_balance : '') }}"
                                    required="" />
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                <x-dash.form.label for=""
                                    value="{{ __('webCaption.opening_balance_type.title') }}" class=""
                                    tooltip="{{ __('webCaption.opening_balance_type.caption') }}" required="" />
                                <div>
                                    <div class="form-check-inline">
                                        <x-dash.form.inputs.radio for="debit"
                                            tooltip="{{ __('webCaption.debit.caption') }}" class="border border-danger"
                                            name="opening_balance_type" label="{{ __('webCaption.debit.title') }}"
                                            value="debit"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <x-dash.form.inputs.file id=""
                                    caption="{{ __('webCaption.user_image.title') }}"
                                    editImageUrl="{{ $editImageUrl }}" ImageId="user_image-preview" for="user_image"
                                    name="user_image" maxFileSize="5000"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @endphp
                                <x-dash.form.inputs.file id=""
                                    caption="{{ __('webCaption.visiting_card_img.title') }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @endphp
                                <x-dash.form.inputs.file id=""
                                    caption="{{ __('webCaption.company_logo.title') }}"
                                    editImageUrl="{{ $editImageUrl }}" ImageId="company_logo-preview"
                                    for="company_logo" name="company_logo" maxFileSize="5000"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <x-dash.form.inputs.number id="" for="credit_limit"
                                    ...
                                    label="{{ __('webCaption.credit_limit.title') }}" class="form-control"
                                    name="credit_limit" placeholder="{{ __('webCaption.credit_limit.title') }}"
                                    maxlength="20"
                                    value="{{ old('credit_limit', isset($data->credit_limit) ? $credit_limit : '') }}"
                                    required="" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <x-dash.form.inputs.select id="" for="storage_days"
                                    ...
                                    label="{{ __('webCaption.storage_days.title') }}" class="form-control"
                                    name="storage_days" placeholder="{{ __('webCaption.storage_days.title') }}"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <x-dash.form.inputs.select id="" for="intial_payment_due_days"
                                    ...
                                    placeholder="{{ __('webCaption.intial_payment_due_days.title') }}" :optionData="$countingArr"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <x-dash.form.inputs.select id="" for="uss_images"
                                    ...
                                    label="{{ __('webCaption.uss_images.title') }}" maxlength="" name="uss_images"
                                    placeholder="{{ __('webCaption.uss_images.title') }}" :optionData="$countingArr"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <x-dash.form.inputs.number id="" for="bid_amount_limit"
                                    tooltip="{{ __('webCaption.bid_amount_limit.caption') }}" maxlength="20"
                                    numberFormat='true' label="{{ __('webCaption.bid_amount_limit.title') }}"
                                    class="form-control" name="bid_amount_limit"
                                    placeholder="{{ __('webCaption.bid_amount_limit.title') }}"
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <x-dash.form.inputs.text id="" for="bid_limit_reason"
                                    ...
                                    label="{{ __('webCaption.bid_limit_reason.title') }}" maxlength="100"
                                    class="form-control" name="bid_limit_reason"
                                    placeholder="{{ __('webCaption.bid_limit_reason.title') }}"
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-2 col-6">
                                    <div class="form-group">
                                        <x-dash.form.label for="" value="{{ __('webCaption.auction.title') }}"
                                            class="" tooltip="{{ __('webCaption.auction.caption') }}"
                                            required="" />
                                        <div>
                                            <div class="form-check-inline">
                                                <x-dash.form.inputs.radio for="auction_yes"
                                                    tooltip="{{ __('webCaption.yes.caption') }}"
                                ...
                                <div class="col-md-2 col-6">
                                    <div class="form-group">
                                        <x-dash.form.label for="" value="{{ __('webCaption.uss.title') }}"
                                            class="" tooltip="{{ __('webCaption.uss.caption') }}"
                                            required="" />
                                        <div>
                                            <div class="form-check-inline">
                                ...
                                <div class="col-md-2 col-6">
                                    <div class="form-group">
                                        <x-dash.form.label for="" value="{{ __('webCaption.bid.title') }}"
                                            class="" tooltip="{{ __('webCaption.bid.caption') }}"
                                            required="" />
                                        <div>
                                            <div class="form-check-inline">
                                ...
                                <div class="col-md-2 col-6">
                                    <div class="form-group">
                                        <x-dash.form.label for="" value="{{ __('webCaption.bid_mail.title') }}"
                                            class="" tooltip="{{ __('webCaption.bid_mail.caption') }}"
                                            required="" />
                                        <div>
                                            <div class="form-check-inline">
                                ...
                                <div class="col-md-2 col-6">
                                    <div class="form-group">
                                        <x-dash.form.label for=""
                                            value="{{ __('webCaption.sales_statistics.title') }}" class=""
                                            tooltip="{{ __('webCaption.sales_statistics.caption') }}" required="" />
                                        <div>
                                            <div class="form-check-inline">
