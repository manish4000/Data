                    ...
                    <div class="table-responsive">
                        <div class="mt-2">
                            ...
                            <div class="px-2 my-2">
                                ...
                                <x-dash.form.buttons.multipleDelete url="{{route('dashmasters.common.yards.delete-multiple')}}" />
                            </div>
                        <table class="table" id="master-list">
                            <thead>
                                <tr>
                                        ...
                                        <th class="position-for-filter-heading" data-toggle="tooltip" title="{{__('webCaption.yards.caption')}}"> {{__('webCaption.yards.title')}}<x-dash.filter.order-by-filter-div orderBy="name" />
                                        </th>
