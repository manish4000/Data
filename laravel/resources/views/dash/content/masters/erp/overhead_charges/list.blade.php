  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="GET" action="{{route('dashmasters.erp.overhead-charges.index')}}">
            <div class="row">
                ...
                <div class="col-md-12 pt-1 text-center">
                    ...
                    <x-dash.form.buttons.reset href="{{route('dashmasters.erp.overhead-charges.index')}}" />
                </div>
            </div>
          </form>
        </div>
                    ...
                    <div class="table-responsive">
                        <div class="mt-2">
                            ...
                            <div class="px-2 my-2">
                                ...
                                <x-dash.form.buttons.multipleDelete url="{{route('dashmasters.erp.overhead-charges.delete-multiple')}}" />
                            </div>
                        <table class="table" id="master-list">
                            <thead>
                                <tr>
                                        ...
                                        <th class="position-for-filter-heading" data-toggle="tooltip" title="{{__('webCaption.overhead_charges.caption')}}"> {{__('webCaption.overhead_charges.title')}}<x-dash.filter.order-by-filter-div orderBy="name" />
                                        </th>
                            ...
                            <tbody>
                                @foreach($data as $item)
                                    @include('dash.content.masters.erp.overhead_charges.item-tr', ['item'=>$item])    
                                @endforeach   
