...
@section('title', __('webCaption.charges.title') )
@else
@section('title', __('webCaption.charges.title'))
@endif
@section('content')
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <x-dash.form.inputs.text  for="charge_name"  tooltip="{{__('webCaption.charge_name.caption')}}" label="{{__('webCaption.charge_name.title')}}" maxlength="50" name="charge_name"  placeholder="{{__('webCaption.charge_name.title')}}" value="{{old('charge_name', isset($data->charge_name)?$data->charge_name:'' )}}" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <x-dash.form.inputs.text for="charge_amount"  maxlength="20" tooltip="{{__('webCaption.charge_amount.caption')}}" label="{{__('webCaption.charge_amount.title')}}" name="charge_amount"  placeholder="{{__('webCaption.charge_amount.title')}}" value="{{old('charge_amount', isset($data->charge_amount)?$data->charge_amount:'' )}}" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
