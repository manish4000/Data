                    ...
                    <div class="table-responsive">
                        <div class="mt-2">
                            ...
                            <div class="px-2 my-2">
                                ...
                                <x-dash.form.buttons.multipleDelete url="{{route('dashmasters.invoices.payment-terms.delete-multiple')}}" />
                            </div>
                        <table class="table" id="master-list">
                            <thead>
                                <tr>
                                        ...
                                        <th class="position-for-filter-heading" data-toggle="tooltip" title="{{__('webCaption.payment_terms.caption')}}"> {{__('webCaption.payment_terms.title')}}<x-dash.filter.order-by-filter-div orderBy="name" />
                                        </th>
