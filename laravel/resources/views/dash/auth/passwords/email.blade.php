    ...
    <div class="card mb-0">
      <div class="card-body">
        <a href="javascript:void(0);" class="brand-logo">
          ...
          <h2 class="brand-text text-primary ml-1">DASH</h2>
        </a>

        <h4 class="card-title mb-1">Forgot Password? 🔒</h4>
        <p class="card-text mb-2">Enter your email and we'll send you instructions to reset your password</p>

        <form class="auth-forgot-password-form mt-2" method="POST" action="{{ route('dashpassword.email') }}">
          @csrf
        ...
        <p class="text-center mt-2">
          @if (Route::has('login'))
          <a href="{{ route('dash') }}"> <i data-feather="chevron-left"></i> Back to login </a>
          @endif
        </p>
      </div>
    </div>
