                                  ...
                                  <ul class="timeline ms-50">
                                      <li class="timeline-item">
                                          ...
                                          <div class="timeline-event">
                                              ...
                                              <div class="d-flex align-items-center">
                                                  <img class="me-1" src="{{asset('assets/images/icons/json.png')}}" alt="data.json" height="23" />
                                          ...
                                          <div class="timeline-event">
                                              ...
                                              <div class="avatar-group">
                                                  <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Billy Hopkins" class="avatar pull-up">
                                                      <img src="{{asset('assets/app-assets/images/portrait/small/avatar-s-9.jpg')}}" alt="Avatar" width="33" height="33" />
                                                  </div>
