    ...
    <div class="card">
      ...
      <div class="card-body">
          <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <x-admin.form.inputs.text id="" label="{{__('webCaption.gabs_uuid.title')}}" for="gabs_uuid"  tooltip="{{__('webCaption.gabs_uuid.caption')}}" class="form-control" maxlength="6" name="gabs_uuid"  placeholder="{{__('webCaption.gabs_uuid.title')}}" value="{{old('gabs_uuid',$data->gabs_uuid )}}"  required="required" />
          ...
          <div class="row">
              <div class="col-md-4">
                  <div class="form-group">
                    <x-admin.form.inputs.email id="" for="email" label="{{__('webCaption.email.title')}}" tooltip="{{__('webCaption.email.caption')}}" maxlength="45" class="form-control" name="email"  placeholder="{{__('webCaption.email.title')}}" value="{{old('email', $data->email)}}"  required="required" />
                    @if($errors->has('email'))
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <x-admin.form.inputs.password id="" label="{{__('webCaption.password.title')}}" tooltip="{{__('webCaption.password.caption')}}" for="password" class="form-control" maxlength="15" name="password"  placeholder="{{__('webCaption.password.title')}}" value=""  required="" />
          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="form-group">
                    <x-admin.form.inputs.textarea id="" for="address" tooltip="{{__('webCaption.address.caption')}}" label="{{__('webCaption.address.title')}}" maxlength="250" class="form-control" name="address"  placeholder="{{__('webCaption.address.title')}}" value="{{old('address', $data->address )}}"  required="" />
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <x-admin.form.inputs.text id="" tooltip="{{__('webCaption.postcode.caption')}}" for="postcode" label="{{__('webCaption.postcode.title')}}" maxlength="15" class="form-control" name="postcode"  placeholder="{{__('webCaption.postcode.title')}}" value="{{old('postcode',$data->postcode)}}"  required="" />
          ...
          <div class="row">
            <div class="col-md-4">
                  <div class="form-group">
                    <x-admin.form.inputs.text id="" for="skype"  tooltip="{{__('webCaption.skype.caption')}}" label="{{__('webCaption.skype.title')}}" maxlength="50" class="form-control" name="skype_id"  placeholder="{{__('webCaption.skype.title')}}" value="{{old('skype_id',$data->skype_id)}}"  required="" />
            ...
            <div class="col-md-4">
                  <div class="form-group">
                    <x-admin.form.inputs.text id="" for="website" tooltip="{{__('webCaption.website.caption')}}" label="{{__('webCaption.website.title')}}" maxlength="75" class="form-control" name="website"  placeholder="{{__('webCaption.website.title')}}" value="{{old('website',$data->website)}}"  required="" />
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                  <x-admin.form.inputs.select tooltip="{{__('webCaption.business_type.caption')}}" label="{{__('webCaption.business_type.title')}}"  id="" for="business_type_id" name="business_type_id" placeholder="{{__('webCaption.business_type_id.title')}}" editSelected="{{old('business_type_id',$data->business_type_id)}}"  required="" :optionData="$BusinessTypes" />
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                  <x-admin.form.inputs.textarea id="" for="permit_number" label="{{__('webCaption.permit_number.title')}}" tooltip="{{__('webCaption.permit_number.caption')}}" maxlength="250" class="form-control" name="permit_no"  placeholder="{{__('webCaption.permit_no.title')}}" 
            ...
            <div class="col-md-6">
                <div class="form-group">
                  <x-admin.form.inputs.textarea id="" for="admin_comment" label="{{__('webCaption.admin_comment.title')}}" tooltip="{{__('webCaption.admin_comment.caption')}}" maxlength="250" class="form-control" name="admin_comment"  placeholder="{{__('webCaption.admin_comment.title')}}" value="{{old('admin_comment', $data->admin_comment)}}"  required="" />
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <x-admin.form.inputs.text_with_icon id="" for="facebook" label="{{__('webCaption.facebook.title')}}" tooltip="{{__('webCaption.facebook.caption')}}"  maxlength="100" class="form-control" name="facebook" iconColorClass="text-primary"  iconClass="fab fa-facebook" placeholder="{{__('webCaption.facebook.title')}}" value="{{old('facebook', $data->facebook)}}"  required="" />
                </div> 
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <x-admin.form.inputs.text_with_icon id="" for="instagram" label="{{__('webCaption.instagram.title')}}" tooltip="{{__('webCaption.instagram.caption')}}" maxlength="100" class="form-control" name="instagram" iconColorClass="text-primary"  iconClass="fab fa-instagram" placeholder="{{__('webCaption.instagram.title')}}" value="{{old('instagram', $data->instagram)}}"  required="" />
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <x-admin.form.inputs.text_with_icon id="" for="linkedin" label="{{__('webCaption.linkedin.title')}}"  tooltip="{{__('webCaption.linkedin.caption')}}" maxlength="100" class="form-control" name="linkedin" iconColorClass="text-primary"  iconClass="fab fa-linkedin" placeholder="{{__('webCaption.linkedin.title')}}" value="{{old('linkedin', $data->linkedin )}}"  required="" />
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <x-admin.form.inputs.text_with_icon id="" for="youtube" tooltip="{{__('webCaption.youtube.caption')}}" label="{{__('webCaption.youtube.title')}}" maxlength="100" class="form-control" name="youtube" iconColorClass="text-primary"  iconClass="fab fa-youtube" placeholder="{{__('webCaption.youtube.title')}}" value="{{old('youtube', $data->youtube )}}"  required="" />
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <x-admin.form.inputs.text_with_icon id="" for="twitter" tooltip="{{__('webCaption.twitter.caption')}}"  label="{{__('webCaption.twitter.title')}}" maxlength="100" class="form-control" name="twitter" iconColorClass="text-primary"  iconClass="fab fa-twitter" placeholder="{{__('webCaption.twitter.title')}}" value="{{old('twitter',$data->twitter)}}"  required="" />
