...
<form action="{{route('company.store')}}" method="POST" enctype="multipart/form-data">
   ...
   <section class="form-control-repeater">
      <div class="card">
         ...
         <div class="card-body">
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="form-group">
                     <x-admin.form.inputs.select label="{{__('webCaption.country.title')}}" 
                        tooltip="{{__('webCaption.country.caption')}}" for="country_id" name="country_id"
      ...
      <div class="card">
         ...
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     <x-admin.form.inputs.select tooltip="{{__('webCaption.business_type.caption')}}" label="{{__('webCaption.business_type.title')}}"  id="" for="business_type_id" name="business_type_id" placeholder="{{__('webCaption.business_type_id.title')}}" editSelected=""  required="" />
      ...
      <div class="card">
         <div class="card-header">
            <h4 class="card-title">
               <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe font-medium-3 mr-1">
                  <circle cx="12" cy="12" r="10"></circle>
      ...
      <div class="form-group">
         <x-admin.form.inputs.checkbox id="" for="terms_and_services"  tooltip="{{__('webCaption.accept_terms_and_services.caption')}}" label="{{__('webCaption.accept_terms_and_services.title')}}"  class="form-control" name="terms_and_services"   value="1" checked="{{ old('terms_and_services') == '1' ? 'checked' : '' }}" />
         &ensp;
      </div>
   </section>
