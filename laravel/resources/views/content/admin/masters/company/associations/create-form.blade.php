...
@section('title', __('webCaption.association.title'). ' ' .__('webCaption.edit.title')  )
@else
@section('title', __('webCaption.association.title').' '. __('webCaption.add.title') )
@endif
...
<section >
  <div class="card">
    <div class="card-header">
			...
			@if(isset($data->id) && !empty($data->id))
			{{__('webCaption.association.title'). ' ' .__('webCaption.edit.title')  }}
			@else
			{{  __('webCaption.association.title').' '. __('webCaption.add.title')}}
			@endif
			</h4>  
		</div>
		<hr class="m-0 p-0">
