...
<section>
    ...
    <div class="card">
        ...
        <div class="card-body pt-75 pb-75 px-50">
          <form method="GET" action="{{route('masters.company.deals-in.index')}}" style="margin-bottom:0px !important;">
            <div class="row">          
        ...
        $permission_and_urls = [
                'multiple_delete' => ['url' => route('masters.company.deals-in.delete-multiple') ,
                                    'permission' => 'masters-company-deals-in-delete'],

                'multiple_update' =>   ['url' => route('masters.company.deals-in.update-multiple') ,
                                     'permission' => 'masters-company-deals-in-update']                               
            ];                          
        @endphp
