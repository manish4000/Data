      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="GET" action="{{route('masters.company.online-payments.index')}}">
            <div class="row">
                <div class="col-sm-4 col-md-5 col-lg-7 col-xl-7">
                    ...
                    <div class="table-responsive">
                        ...
                        @can('masters-company-online-payments-delete')
                             <div class="px-2 my-2">
                                ...
                                <x-admin.form.buttons.multipleDelete url="{{route('masters.company.online-payments.delete-multiple')}}" />
                            </div> 
                        @endcan
                        ...
                        <table class="table" id="master-list">
                            <thead>
                                <tr>
                                        ...
                                        <th class="position-for-filter-heading" data-toggle="tooltip" title="{{__('webCaption.online_payments.caption')}}"> {{__('webCaption.online_payments.title')}}<x-admin.filter.order-by-filter-div orderBy="name" />
                                        </th>
                                ...
                                @foreach($data as $item)
                                    ...
                                    @if( true || request()->input('search.parentOnlyShowAll') == 1)
                                        @foreach($item->children as $childItem)
                                            @include('content.admin.masters.company.online_payments.item-tr', ['item'=>$childItem])    
                                        @endforeach 
                                    @endif
                                @endforeach   
