...
<section>
    ...
    <div class="card">
        ...
        <div class="card-body pt-75 pb-75 px-50">
          <form method="GET" action="{{route('masters.company.marketing-status.index')}}" style="margin-bottom:0px !important;">
            <div class="row">
       ...
       @php
        ...
        $permission_and_urls = [
                'multiple_delete' => ['url' => route('masters.company.marketing-status.delete-multiple') ,
                                    'permission' => 'masters-company-marketing-status-delete'],

                'multiple_update' =>   ['url' => route('masters.company.marketing-status.update-multiple') ,
                                     'permission' => 'masters-company-marketing-status-update']                               
            ];                          
        @endphp
