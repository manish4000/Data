  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="GET" action="{{route('masters.company.business-type.index')}}">
            <div class="row">
                        ...
                        <table class="table" id="master-list">
                            <thead>
                                <tr>
                                        ...
                                        <th class="position-for-filter-heading" data-toggle="tooltip" title="{{__('webCaption.business_type.caption')}}"> {{__('webCaption.business_type.title')}}<x-admin.filter.order-by-filter-div orderBy="name" />
                                        </th>
