                    ...
                    <div class="table-responsive">
                        ...
                        @can('masters-social-media-delete')
                             <div class="px-2 my-2">
                                ...
                                <x-admin.form.buttons.multipleDelete url="{{route('masters.social-media.delete-multiple')}}" />
                            </div> 
                        @endcan
                        ...
                        <table class="table" id="master-list">
                            <thead>
                                <tr>
                                        ...
                                        <th class="position-for-filter-heading" data-toggle="tooltip" title="{{__('webCaption.social_media.caption')}}"> {{__('webCaption.social_media.title')}}<x-admin.filter.order-by-filter-div orderBy="name" />
                                        </th>
