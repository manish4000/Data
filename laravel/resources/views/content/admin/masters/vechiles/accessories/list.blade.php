  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="GET" action="{{route('masters.vehicle.accessories.index')}}">
            <div class="row">
                    ...
                    <div class="table-responsive">
                        ...
                        @can('masters-vehicle-accessories-delete')
                            <div class="px-2 my-2">
                                ...
                                <x-admin.form.buttons.multipleDelete url="{{route('masters.vehicle.accessories.delete-multiple')}}" />
                            </div>
                        @endcan
