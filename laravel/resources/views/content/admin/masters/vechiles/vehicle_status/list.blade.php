  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="GET" action="{{route('masters.vehicle.vehicle-status.index')}}">
            <div class="row">
        ...
        <!-- Basic Tables start -->
          <div class="card-body">
            @can('masters-vehicle-vehicle-status') 
                @if(count($data) > 0 )
                    <div class="table-responsive">
                        ...
                        @can('masters-vehicle-vehicle-status-delete')
                            <div class="px-2 my-2">
                                ...
                                <x-admin.form.buttons.multipleDelete url="{{route('masters.vehicle.vehicle-status.delete-multiple')}}" />
                            </div>
                        @endcan
