...
<section> 
    ...
    <div class="card">
        ...
        <div class="card-body pt-75 pb-75 px-50">
          <form method="GET" action="{{route('masters.vehicle.type.index')}}" style="margin-bottom:0px !important;">
            <div class="row">
        ...
        $permission_and_urls = [
                'multiple_delete' => ['url' => route('masters.vehicle.type.delete-multiple') ,
                                    'permission' => 'main-navigation-masters-vehicle-type-delete'],

                'multiple_update' =>   ['url' => route('masters.vehicle.type.update-multiple') ,
                                     'permission' => 'main-navigation-masters-vehicle-type-update']                               
            ];                          
        @endphp
