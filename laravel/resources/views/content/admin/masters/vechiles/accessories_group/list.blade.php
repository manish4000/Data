    ...
    <!-- filter  -->
      <div class="card">
        ...
        <div class="card-body pt-75 pb-75 px-50">
          <form method="GET" action="{{route('masters.vehicle.accessories-group.index')}} "style="margin-bottom:0px !important;">
            <div class="row">
        ...
        $permission_and_urls = [
            'multiple_delete' => ['url' => route('masters.vehicle.accessories-group.delete-multiple') ,
                                 'permission' => 'masters-vehicle-accessories-group-delete'],

            'multiple_update' =>  ['url' => route('masters.vehicle.accessories-group.update-multiple') ,
                                  'permission' => 'masters-vehicle-accessories-group-update'] 
