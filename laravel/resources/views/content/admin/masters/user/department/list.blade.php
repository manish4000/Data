  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="GET" action="{{route('masters.user.department.index')}}">
            <div class="row">
                        ...
                        <table class="table" id="master-list">
                            <thead>
                                <tr>
                                        ...
                                        <th class="position-for-filter-heading" data-toggle="tooltip" title="{{__('webCaption.department.caption')}}"> {{__('webCaption.department.title')}}<x-admin.filter.order-by-filter-div orderBy="name" />
                                        </th>
