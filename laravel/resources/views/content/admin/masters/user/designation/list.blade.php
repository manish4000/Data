...
<section>
    ...
    <div class="card">
        ...
        <div class="card-body pt-75 pb-75 px-50">
          <form method="GET" action="{{route('masters.user.designation.index')}}" style="margin-bottom:0px !important;">
            <div class="row">
        ...
        $permission_and_urls = [
                'multiple_delete' => ['url' => route('masters.user.designation.delete-multiple') ,
                                    'permission' => 'masters-user-designation-delete'],

                'multiple_update' =>   ['url' => route('masters.user.designation.update-multiple') ,
                                     'permission' => 'masters-user-designation-update']                               
            ];                          
        @endphp
