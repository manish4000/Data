...
<section>
    ...
    <div class="card">
        ...
        <div class="card-body pt-75 pb-75 px-50">
          <form method="GET" action="{{route('common.religion.index')}}" style="margin-bottom:0px !important;">
            <div class="row">
        ...
        $permission_and_urls = [
                'multiple_delete' => ['url' => route('common.religion.delete-multiple') ,
                                    'permission' => 'common-religion-delete'],

                'multiple_update' =>   ['url' => route('common.religion.update-multiple') ,
                                     'permission' => 'common-religion-update']                               
            ];                          
        @endphp
