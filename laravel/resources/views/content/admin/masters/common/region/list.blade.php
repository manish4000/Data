...
<section>
    ...
    <div class="card">
        ...
        <div class="card-body pt-75 pb-75 px-50">
          <form method="GET" action="{{route('common.region.index')}}" style="margin-bottom:0px !important;">
            <div class="row">
                ...
                <div class="col-md-12 pt-0 text-center">
                    ...
                    <x-admin.form.buttons.reset href="{{route('common.region.index')}}" />
                </div>
            </div>
          </form>
        </div>
        ...
        $permission_and_urls = [
                'multiple_delete' => ['url' => route('common.region.delete-multiple') ,
                                    'permission' => 'common-region-delete'],

                'multiple_update' =>   ['url' => route('common.region.update-multiple') ,
                                     'permission' => 'common-region-update']                               
            ];                          
        @endphp
                ...
                @foreach($data as $item)
                    @include('content.admin.masters.common.region.item-tr', ['item'=>$item])    
                        ...
                        @foreach($item->children as $childItem)
                            @include('content.admin.masters.common.region.item-tr', ['item'=>$childItem])    
                        @endforeach                                        
                        @endif
                @endforeach      
