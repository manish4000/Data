...
@section('title', __('webCaption.edit_region.title') )
@else
@section('title', __('webCaption.add_region.title'))
@endif
...
<section >
  <div class="card">
    <div class="card-header">
			...
			@if(isset($data->id))  {{__('webCaption.edit_region.title')}}  @else {{__('webCaption.add_region.title')}} @endif 
			</h4>  
		</div>
		<hr class="m-0 p-0">
