  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="GET" action="{{route('common.ports.index')}}">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 pt-1 ">
                    ...
                    <x-admin.form.buttons.reset href="{{route('common.ports.index')}}" />
                </div>
            </div>
          </form>
        </div>
                    ...
                    <div class="table-responsive">
                        ...
                        @can('common-ports-delete')
                            <div class="px-2 my-2">
                                ...
                                <x-admin.form.buttons.multipleDelete url="{{route('common.ports.delete-multiple')}}" />
                            </div>
                        @endcan
                        <table class="table" id="master-list">
                            <thead>
                                <tr>
                                        ...
                                        <th class="position-for-filter-heading" data-toggle="tooltip" title="{{__('webCaption.ports.caption')}}"> {{__('webCaption.ports.title')}}<x-admin.filter.order-by-filter-div orderBy="name" />
                                        </th>
