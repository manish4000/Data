...
<section>
    ...
    <div class="card">
        ...
        <div class="card-body pt-75 pb-75 px-50">
          <form method="GET" action="{{route('common.ports.index')}}" style="margin-bottom:0px !important;">
            <div class="row">
        ...
        $permission_and_urls = [
                'multiple_delete' => ['url' => route('common.ports.delete-multiple') ,
                                    'permission' => 'common-ports-delete'],

                'multiple_update' =>   ['url' => route('common.ports.update-multiple') ,
                                     'permission' => 'common-ports-update']                               
            ];                          
        @endphp
