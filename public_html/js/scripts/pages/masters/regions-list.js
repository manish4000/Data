...
$(function () {
  ...
  var dtUserTable = $('.regions-list-table'),
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:void(0)" class="dropdown-item delete-record" onclick="___deleteRecord('+full['id']+');">' + feather.icons['trash-2'].toSvg({ class: 'font-small-4 mr-50' }) + '</a></div>' +
              '</div>' +
              '</div>'
            );
          }
