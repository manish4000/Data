...
function TreeSortable() {
    var treeSortable = {
        ...
        createBranch({ id, parent_id, title, level ,type}) {
            const {
                options: {
                    branchSelector,
                    branchPathSelector,
            ...
            <div class="contents">
                ...
                <div class="branch-wrapper">
                    ...
                    <div class="right-sidebar">
                        <button type="button" class="button" onclick="editMenu(${id})" title="Edit">
                            <ion-icon name="create-outline"></ion-icon>
                        </button>
                        <button type="button" class="button remove-branch" data-id="${id}"  title="Remove Branch">
        ...
        jQuerySupplements() {
            ...
            $.fn.extend({
                ...
                addChildBranch() {
                    ...
                    const $element = createBranch({ id: uid, parent_id, title, level,type });
                ...
                addSiblingBranch() {
                    ...
                    const $element = createBranch({ id: uid, parent_id, level, title ,type});
