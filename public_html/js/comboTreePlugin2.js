...
;(function ( $, window, document, undefined ) {
  ...
  ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
    var checked = "";
    var checkedClass = "";
    if (typeof(seItem) == 'object' && seItem != null &&  seItem.includes(sourceItem.slug)) {
      checked = "checked";
      checkedClass = "checkedBackground";
    }

    if ( typeof(seItem) == 'number' && seItem == sourceItem.id ) {
      checked = "checked";
      checkedClass = "checkedBackground";
    }
    ...
    if (this.options.isMultiple)
      itemHtml += '<span data-id="' + sourceItem.id + '" data-selectable="' + isSelectable + '" class="comboTreeItemTitle ' + selectableClass +' '+ checkedClass + '">' + (isSelectable ? '<input type="checkbox" value="'+sourceItem.value +'" name="items[]" '+checked+' />' : '') + sourceItem.title + '</span>';
    else
      itemHtml += '<label style="font-weight: 500; margin-bottom: 0px"><span data-id="' + sourceItem.id + '" data-selectable="' + isSelectable + '" class="comboTreeItemTitle ' + selectableClass +' '+ checkedClass + '">' + (isSelectable ? '<input type="radio" value="'+sourceItem.value +'" name="item_id" style="visibility: hidden; margin-left: -10px" '+checked+' />' : '') + sourceItem.title + '</span></label>';
