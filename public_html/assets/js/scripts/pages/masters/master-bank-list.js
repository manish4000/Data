      ...
      columnDefs: [
      ...
      },
        {
          ...
          render: function (data, type, full, meta) {
            var $row_output = '<div class="d-flex justify-content-left align-items-center p-0 m-0"><div class="d-flex flex-column p-0 m-0"><p class="font-weight-bold p-0 m-0">';
            $row_output += '<img src="'+base_url+'/uploads/banks/'+full['icon']+'"/>';
            $row_output += '</p></div></div>';
            return $row_output;
          }
        },
        {
