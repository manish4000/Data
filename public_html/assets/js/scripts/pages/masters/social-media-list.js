      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            // Creates full output for row
            var $row_output =
              '<div class="d-flex justify-content-left align-items-center">' + '<div class="d-flex flex-column">' + '<span class="font-weight-bold">' + $url + '</span>' + '</div>' + '</div>';
            return $row_output;
          }
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            // Creates full output for row
            var $row_output =
              '<div class="d-flex justify-content-left align-items-center">' + '<div class="d-flex flex-column">' + '<span class="font-weight-bold "><i data-feather="' + $icon + '"></i></span>' + '</div>' + '</div>';
            return $row_output;
          }
        },
        {
